...
METHOD Init( oParent, aParams, cProjectName ) CLASS MDIChildWindow
   ...
   ::ClassStyle  := hb_bitor(CS_VREDRAW, CS_HREDRAW)
   ::Style       := hb_bitor(WS_CHILD, WS_CAPTION, WS_SYSMENU, WS_CLIPCHILDREN, WS_CLIPSIBLINGS, WS_MAXIMIZEBOX, WS_MINIMIZEBOX, WS_THICKFRAME)
   ::IsContainer := .F.
RETURN Self
...
METHOD Create() CLASS MDIChildWindow
   ...
   ::ExStyle := hb_bitor(::ExStyle, WS_EX_MDICHILD)
   ::Super:Create()
